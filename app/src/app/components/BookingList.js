...
import './ClientBookings.css'; // Import the CSS file
...
const ClientBookings = ({ client }) => {
    ...
    }, [clientId]);  // Use clientId instead of client.id to avoid unnecessary re-fetching
                    ...
                    {bookings.map((booking) => (
                        <div className="booking-card" key={booking.id}>
                            ...
                            <DeleteBookingButton
                                ...
                                client={client}
                                onDeleteSuccess={() => handleDelete(booking.id)} // Pass handleDelete as the callback
                            />
                        </div>
                    ))}
                </div>
